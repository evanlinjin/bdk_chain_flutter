...
// Section: finalizer
  ...
  late final OpaqueTypeFinalizer _CounterFinalizer =
      OpaqueTypeFinalizer(inner._drop_opaque_CounterPtr);
...
class NativeWire implements FlutterRustBridgeWireBase {
  ...
  late final _wire_new_counterPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64)>>(
          'wire_new_counter');
  late final _wire_new_counter =
      _wire_new_counterPtr.asFunction<void Function(int)>();
  ...
  late final _wire_increment_counterPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64, wire_Counter)>>(
          'wire_increment_counter');
  late final _wire_increment_counter =
      _wire_increment_counterPtr.asFunction<void Function(int, wire_Counter)>();

  void wire_decrement_counter(
    int port_,
    wire_Counter counter,
  ) {
    return _wire_decrement_counter(
      port_,
      counter,
    );
  }

  late final _wire_decrement_counterPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64, wire_Counter)>>(
          'wire_decrement_counter');
  ...
  late final _new_CounterPtr =
      _lookup<ffi.NativeFunction<wire_Counter Function()>>('new_Counter');
  late final _new_Counter =
      _new_CounterPtr.asFunction<wire_Counter Function()>();
  ...
  late final _drop_opaque_CounterPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
          'drop_opaque_Counter');
  late final _drop_opaque_Counter = _drop_opaque_CounterPtr
  ...
  late final _share_opaque_CounterPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<ffi.Void> Function(
              ffi.Pointer<ffi.Void>)>>('share_opaque_Counter');
  late final _share_opaque_Counter = _share_opaque_CounterPtr
